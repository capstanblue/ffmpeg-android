...
#define FFMPEG_CONFIGURATION "--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/home/johannes/Stuff/android-development-stuff/android-ndk-r7b/platforms/android-5/arch-arm --enable-static --disable-symver --enable-small --optimization-flags=-O2 --disable-everything --enable-protocol=file --enable-parser=mpeg4video --enable-demuxer=mov --enable-decoder=mpeg4 --enable-version3 --enable-nonfree --disable-doc --disable-ffserver --prefix=../build/ffmpeg/armeabi --extra-cflags= --extra-ldflags="
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define FFMPEG_DATADIR "../build/ffmpeg/armeabi/share/ffmpeg"
#define CC_TYPE "gcc"
