...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/home/johannes/Stuff/android-ndk-r6b//platforms/android-5/arch-arm --enable-static --disable-symver --enable-small --optimization-flags=-O2 --enable-version3 --enable-nonfree --disable-doc --disable-ffserver --prefix=../build/ffmpeg/armeabi --extra-cflags= --extra-ldflags=
...
SONAME_PREFIX=
SRC_PATH="/home/johannes/Stuff/workspace/VideoLWP/jni/ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/home/johannes/Stuff/workspace/VideoLWP/jni/ffmpeg-android/ffmpeg
BUILD_ROOT="/home/johannes/Stuff/workspace/VideoLWP/jni/ffmpeg-android/ffmpeg"
...
CPPFLAGS= --sysroot=/home/johannes/Stuff/android-ndk-r6b//platforms/android-5/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
...
ASFLAGS=   -fPIC -g
CC_O=-o $@
LDFLAGS=  --sysroot=/home/johannes/Stuff/android-ndk-r6b//platforms/android-5/arch-arm -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
